 ...
 */
final class Version20201007131949 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category DROP FOREIGN KEY FK_64C19C131248CA2');
        $this->addSql('DROP INDEX IDX_64C19C131248CA2 ON category');
        $this->addSql('ALTER TABLE category DROP blogpost_category_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category ADD blogpost_category_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE category ADD CONSTRAINT FK_64C19C131248CA2 FOREIGN KEY (blogpost_category_id) REFERENCES blog_post (id)');
        $this->addSql('CREATE INDEX IDX_64C19C131248CA2 ON category (blogpost_category_id)');
    }
}
